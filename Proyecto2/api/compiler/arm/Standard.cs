...
public class StandardLibrary{
    ...
    public void Use(string functionName){
        usedFunctions.Add(functionName);
         if (functionName == "print_integer")
        {
            usedSymbols.Add("minus_sign");
        }
        else if (functionName == "print_double")
        {
...
print_result:
    ...
    //imprimir newLine in Result
    //mov x0, #1              // fd = 1 (stdout)
    //adr x1, newline         // dirección del buffer con salto de linea
